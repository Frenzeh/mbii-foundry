...
class MBCHParser:
    ...
    def validate(self, char: MBCHCharacter) -> List[str]:
        ...
        valid_classes = [
            ...
            "MB_CLASS_ENFORCER", "MB_CLASS_SPY", "MB_CLASS_ASTRODROID",
            "MB_CLASS_ASTROMECH", "MB_CLASS_BATTLEDROID", "MB_CLASS_JETTROOPER",
            "MB_CLASS_ASSASSINDROID", "MB_CLASS_PATROLIAN",
            "MB_CLASS_IMPMEDIC", "MB_CLASS_REBMEDIC"
        ]
